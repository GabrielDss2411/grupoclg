    ...
    <div data-slider class="hide-scroll" style="display:flex;gap:20px;overflow-x:auto;scroll-snap-type:x proximity;scroll-behavior:smooth;padding:28px 2px 12px">
      ...
      <div style="flex:0 0 300px;scroll-snap-align:start;background:#fff;border:1px solid #e5e5ea;border-radius:16px;overflow:hidden;display:flex;flex-direction:column;transition:box-shadow .25s ease, border-color .25s ease" data-hv="hv7">
        ...
        <div style="padding:20px 22px;flex:1;display:flex;flex-direction:column;gap:12px">
          ...
          <button data-nav="cursos" style="margin-top:auto;background:#0C1A57;color:#fff;border:0;border-radius:999px;padding:12px;font-weight:700;font-size:14px;cursor:pointer;width:100%;display:inline-flex;align-items:center;justify-content:center;gap:8px" data-hv="hv8">Garantir vaga <span>→</span></button>
        </div>
      </div>
      <!-- CARD -->
      <div style="flex:0 0 300px;scroll-snap-align:start;background:#fff;border:1px solid #e5e5ea;border-radius:16px;overflow:hidden;display:flex;flex-direction:column;transition:box-shadow .25s ease, border-color .25s ease" data-hv="hv9">
        ...
        <div style="padding:20px 22px;flex:1;display:flex;flex-direction:column;gap:12px">
          ...
          <button data-nav="cursos" style="margin-top:auto;background:#0C1A57;color:#fff;border:0;border-radius:999px;padding:12px;font-weight:700;font-size:14px;cursor:pointer;width:100%;display:inline-flex;align-items:center;justify-content:center;gap:8px" data-hv="hv10">Garantir vaga <span>→</span></button>
        </div>
      </div>
      <!-- CARD -->
      <div style="flex:0 0 300px;scroll-snap-align:start;background:#fff;border:1px solid #e5e5ea;border-radius:16px;overflow:hidden;display:flex;flex-direction:column;transition:box-shadow .25s ease, border-color .25s ease" data-hv="hv11">
        ...
        <div style="padding:20px 22px;flex:1;display:flex;flex-direction:column;gap:12px">
          ...
          <button data-nav="cursos" style="margin-top:auto;background:#0C1A57;color:#fff;border:0;border-radius:999px;padding:12px;font-weight:700;font-size:14px;cursor:pointer;width:100%;display:inline-flex;align-items:center;justify-content:center;gap:8px" data-hv="hv12">Garantir vaga <span>→</span></button>
        </div>
      </div>
      <!-- CARD -->
      <div style="flex:0 0 300px;scroll-snap-align:start;background:#fff;border:1px solid #e5e5ea;border-radius:16px;overflow:hidden;display:flex;flex-direction:column;transition:box-shadow .25s ease, border-color .25s ease" data-hv="hv13">
        ...
        <div style="padding:20px 22px;flex:1;display:flex;flex-direction:column;gap:12px">
          ...
          <button data-nav="cursos" style="margin-top:auto;background:#0C1A57;color:#fff;border:0;border-radius:999px;padding:12px;font-weight:700;font-size:14px;cursor:pointer;width:100%;display:inline-flex;align-items:center;justify-content:center;gap:8px" data-hv="hv14">Garantir vaga <span>→</span></button>
        </div>
      </div>
      <!-- CARD -->
      <div style="flex:0 0 300px;scroll-snap-align:start;background:#fff;border:1px solid #e5e5ea;border-radius:16px;overflow:hidden;display:flex;flex-direction:column;transition:box-shadow .25s ease, border-color .25s ease" data-hv="hv15">
        ...
        <div style="padding:20px 22px;flex:1;display:flex;flex-direction:column;gap:12px">
          ...
          <button data-nav="cursos" style="margin-top:auto;background:#0C1A57;color:#fff;border:0;border-radius:999px;padding:12px;font-weight:700;font-size:14px;cursor:pointer;width:100%;display:inline-flex;align-items:center;justify-content:center;gap:8px" data-hv="hv16">Garantir vaga <span>→</span></button>
        </div>
      </div>
      <!-- CARD -->
      <div style="flex:0 0 300px;scroll-snap-align:start;background:#fff;border:1px solid #e5e5ea;border-radius:16px;overflow:hidden;display:flex;flex-direction:column;transition:box-shadow .25s ease, border-color .25s ease" data-hv="hv17">
        ...
        <div style="padding:20px 22px;flex:1;display:flex;flex-direction:column;gap:12px">
          ...
          <button data-nav="cursos" style="margin-top:auto;background:#0C1A57;color:#fff;border:0;border-radius:999px;padding:12px;font-weight:700;font-size:14px;cursor:pointer;width:100%;display:inline-flex;align-items:center;justify-content:center;gap:8px" data-hv="hv18">Garantir vaga <span>→</span></button>
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="max-width:1200px;margin:0 auto;padding:52px 30px 90px">
    ...
    <div data-row>
      ...
      <div data-slider class="hide-scroll" style="display:flex;gap:24px;overflow-x:auto;scroll-snap-type:x proximity;scroll-behavior:smooth;padding:4px 2px 12px">
        <div data-nav="cursos" style="cursor:pointer;flex:0 0 300px;scroll-snap-align:start">
...
export const navbar = `<div style="position:fixed;top:0;left:0;right:0;z-index:60;padding:18px 24px;display:flex;justify-content:center;pointer-events:none">
  <div style="pointer-events:auto;width:100%;max-width:1200px;margin:0 auto;padding:12px 16px 12px 20px;display:flex;align-items:center;gap:36px;background:rgba(10,16,40,0.72);backdrop-filter:blur(16px);-webkit-backdrop-filter:blur(16px);border:1px solid rgba(255,255,255,0.1);border-radius:20px;box-shadow:0 14px 40px -26px rgba(0,0,0,0.5)">
    ...
    <nav style="display:flex;gap:4px;margin-left:8px">
      <button data-nav="home" style="position:relative;background:none;border:0;cursor:pointer;font-size:15px;font-weight:500;color:rgba(255,255,255,0.72);padding:9px 16px;border-radius:999px" data-hv="hv36"><span style="position:relative">Home</span></button>
      <button data-nav="cursos" style="position:relative;background:none;border:0;cursor:pointer;font-size:15px;font-weight:500;color:rgba(255,255,255,0.72);padding:9px 16px;border-radius:999px" data-hv="hv37"><span style="position:relative">Cursos</span></button>
      <button data-nav="incompany" style="position:relative;background:none;border:0;cursor:pointer;font-size:15px;font-weight:500;color:rgba(255,255,255,0.72);padding:9px 16px;border-radius:999px" data-hv="hv38"><span style="position:relative">In Company</span></button>
      <button data-nav="sobre" style="position:relative;background:none;border:0;cursor:pointer;font-size:15px;font-weight:500;color:rgba(255,255,255,0.72);padding:9px 16px;border-radius:999px" data-hv="hv39"><span style="position:relative">Sobre</span></button>
    </nav>
